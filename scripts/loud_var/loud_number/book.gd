...
func _init(_type: Type):
	...
	match type:
		...
		Type.BIG:
			...
			sync = func(base: Big) -> Big:
				var result: Big = Big.new(base)
				result.plus_equals(get_added())
...
func add_adder(object: LoudNumber) -> void:
...
func remove_adder(object: LoudNumber) -> void:
...
func adder_changed(object: LoudNumber) -> void:
	edit_change(Book.Category.ADDED, object, object.get_value())


func add_subtracter(object: LoudNumber) -> void:
...
func remove_subtracter(object: LoudNumber) -> void:
...
func subtracter_changed(object: LoudNumber) -> void:
	edit_change(Book.Category.SUBTRACTED, object, object.get_value())

#region Multipliers

func add_multiplier(object: LoudNumber) -> void:
...
func remove_multiplier(object: LoudNumber) -> void:
...
func add_conditional_multiplier(conditional_entry: ConditionalEntry) -> void:
	assert(
		not conditional_multipliers.has(conditional_entry.source),
...
func multiplier_changed(object: LoudNumber) -> void:
...
func remove_divider(object: LoudNumber) -> void:
...
func divider_changed(object: LoudNumber) -> void:
	edit_change(Book.Category.DIVIDED, object, object.get_value())


func add_powerer(base: LoudNumber, exponent: LoudNumber, offset := 0) -> void:
	var power_up: Callable = func() -> void:
		...
		edit_change(Book.Category.MULTIPLIED, base, Big.power(base.val(), offset_amount))
	power_up.call()
